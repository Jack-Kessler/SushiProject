...
namespace SushiProject.Controllers
{
    public class FoodBevOrderController : Controller
    {
        ...
        public IActionResult InsertFoodBevOrderToDatabase(FoodBevOrder foodBevOrderToInsert)
        {
            ...
            {
                repo.CleanUpInvalidMenuItemsSQL(foodBevOrderToInsert); //Basically 
                repo.InsertFoodBevOrderSQL(foodBevOrderToInsert); //Inserting food bev order into database

                int orderNum = repo.RetrieveOrderNumSQL(foodBevOrderToInsert.TransactionID, foodBevOrderToInsert.DateAndTime); //retrieves food bev order ID generated by database automatially
                foodBevOrderToInsert.OrderID = orderNum; //attaches food bev order ID
